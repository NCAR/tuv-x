...
function(create_standard_test)
  ...
  target_link_libraries(test_${TEST_NAME} PUBLIC musica::tuvx tuvx_test_utils ${BLAS_LIBRARIES} GTest::gtest_main)
  ...
  if(TUVX_ENABLE_LAPACK)
    target_link_libraries(test_${TEST_NAME} PUBLIC ${LAPACK_LIBRARIES})
  endif()
