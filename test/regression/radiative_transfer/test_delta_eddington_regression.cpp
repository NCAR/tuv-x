...
//
// Reference CSVs are generated by generate_reference.py (Python port of the
// same algorithm).  Regenerate them whenever the test atmosphere or SZA list
// changes, then commit the new files.
//
