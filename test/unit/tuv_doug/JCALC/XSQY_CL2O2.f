      subroutine XSQY_CL2O2(nw,wl,wc,nz,tlev,airlev,j,sq,jlabel,pn)
!-----------------------------------------------------------------------------!
!   purpose:                                                                  !
!   provide product (cross section) x (quantum yield) for hcl photolysis:     !
!          cl2o2 + hv -> cl + cloo                                            !
!   cross section: from JPL10                                                 !
!                                                                             !
!-----------------------------------------------------------------------------!
!   parameters:                                                               !
...
!----------------------------------------------
!     ... jlabel(j) = 'cl2o2 -> cl + cloo'
!----------------------------------------------
      j = j+1
      jlabel(j) = 'Cl2O2 + hv -> Cl + ClOO'
!      print*,jlabel(j)
!----------------------------------------------------
!     ... cross sections 
!----------------------------------------------------
      open(kin,file=
     $ TRIM(pn)//'XS_CL2O2_JPL10_500nm.txt',status='old')
