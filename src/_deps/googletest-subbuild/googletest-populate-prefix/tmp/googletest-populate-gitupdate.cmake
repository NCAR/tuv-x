...
execute_process(
  COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git show-ref "be03d00f5f0cc3a997d1a368bee8a1fe93651f48"
  WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/glade/derecho/scratch/adityad/tuv-x/src/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/glade/derecho/scratch/adityad/tuv-x/src/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
