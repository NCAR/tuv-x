...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
...
execute_process(
  COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git show-ref "0.8.0"
  WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
...
execute_process(
  COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src'."
    ...
    execute_process(
      COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
    )
    execute_process(
      COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
      )
      execute_process(
        COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/glade/u/apps/casper/23.10/opt/view/bin/git" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "/glade/derecho/scratch/adityad/tuv-x/src/_deps/yaml-cpp-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
